...
import com.maehem.rotor.engine.data.RealmState;
...
public class Realm {
    ...
    private RealmState state = new RealmState();
   ...
   /**
    ...
    public final void loadState(World world, DataInputStream dis) throws IOException {
